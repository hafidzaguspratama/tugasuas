...
<nav>
    <ul>    
          ...
          <li ><a href="tentang.php" title="About">About</a></li>
          <li class="active"><a href="index.php" title="Home">Home</a></li>
          <button class="coco" ><a href="login.php" title="Dashboard"><i class="fa fa-cloud-upload"> Dashboard</i></a></button></li>

    </ul>
</nav>

<?php include_once 'section.php'; ?>
    <h1 style="text-align: center; color: #cfd8dc; font-size: 40px;">PRODUCT US</h1>
